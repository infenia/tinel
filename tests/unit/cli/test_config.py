...
class TestFromArgs:
    ...
    def test_from_args_basic(self):
        ...
        args = argparse.Namespace(
            format="text", no_color=False, verbose=0, quiet=False, config=None
        )
    ...
    def test_from_args_quiet_mode(self):
        ...
        args = argparse.Namespace(
            format="yaml", no_color=False, verbose=0, quiet=True, config=None
        )
...
class TestValidation:
    ...
    def test_validate_success(self):
        ...
        config = CLIConfig(format_type="json", use_color=True, verbose=1, quiet=False)
    ...
    def test_validate_conflicting_verbose_quiet(self):
        ...
        with pytest.raises(
            ValueError, match="Cannot use both verbose and quiet modes together"
        ):
            config.validate()
