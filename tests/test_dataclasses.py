...
def test_kernel_config_option_valid_instantiation():
    """
    Tests that KernelConfigOption can be successfully instantiated with all valid inputs.
    """
    option = KernelConfigOption(name="CONFIG_SECURITY_SELINUX", value="y", recommended="n")
...
def test_kernel_config_option_raises_error_for_empty_name():
    """
    Tests that instantiating KernelConfigOption with an empty name raises a ValueError.
    """
...
def test_kernel_config_option_raises_error_for_invalid_value():
    """
    Tests that instantiating KernelConfigOption with an invalid value raises a ValueError.
    """
...
def test_kernel_config_instantiation_with_empty_list():
    """
    Tests that KernelConfig can be successfully instantiated with an empty list of options.
    """
...
def test_kernel_config_instantiation_with_valid_options():
    """
    Tests that KernelConfig correctly stores a list of valid KernelConfigOption instances.
    """
    options = [
    ...
    assert config.options[0].name == "CONFIG_SECURITY_SELINUX"
    assert config.options[1].value == "n"
    assert config.options[2].recommended is None
