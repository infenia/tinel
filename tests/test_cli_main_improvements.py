#!/usr/bin/env python3
"""Tests for Improved CLI Main Module.
...
from infenix.cli.main import main, _validate_and_sanitize_argv, _execute_main_logic
from infenix.cli.config import CLIConfig
...
class TestMainFunctionImprovements(unittest.TestCase):
    ...
    @patch('infenix.cli.main._execute_main_logic')
...
class TestPerformanceMonitoring(unittest.TestCase):
    ...
    @patch('infenix.cli.main.CLIConfig')
    @patch('infenix.cli.main.setup_logging')
    @patch('infenix.cli.main.OutputFormatter')
    @patch('infenix.cli.main.CLIErrorHandler')
    @patch('infenix.cli.main._get_command_router')
    @patch('time.time')
    def test_execution_time_logging(self, mock_time, mock_get_router, mock_error_handler_class,
                                   mock_formatter_class, mock_setup_logging, mock_config_class,
                                   mock_parse_args):
        ...
        mock_logger.info.assert_any_call("CLI execution completed successfully in 1.500s")
...
class TestLazyLoading(unittest.TestCase):
    ...
    def test_lazy_command_router_loading(self, mock_router_class):
        ...
        from infenix.cli.main import _get_command_router
