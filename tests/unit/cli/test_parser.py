...
class TestArgumentParser:
    ...
    def test_create_argument_parser(self):
        ...
        assert 'Tinel - AI-powered Linux system diagnostics and hardware analysis' in parser.description
...
class TestHardwareCommands:
    ...
    def test_hardware_cpu_command(self):
        ...
        args = parser.parse_args(['hardware', 'cpu', '--detailed', '--temperature', '--features'])
...
@pytest.mark.parametrize("command,subcommand,expected_attrs", [
...
def test_hardware_command_attributes(command, subcommand, expected_attrs):
    ...
    for attr in expected_attrs:
        assert hasattr(args, attr), f"Missing attribute {attr} for {command} {subcommand}"
