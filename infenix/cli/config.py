#!/usr/bin/env python3
"""Configuration Management for Infenix CLI.

This module provides configuration management for the Infenix CLI,
centralizing configuration options and validation.
